...
export class PostService {
  ...
  constructor() {
    this.posts = [
      { titulo: 'Me llamo Ralph', texto: 'Mi mono ameyo y yo', autor: 'Doctalanstrum', imagen: 'https://static3.cbrimages.com/wordpress/wp-content/uploads/2021/01/The-Simpsons-Ralph-Chief-Wiggum-2.jpg?q=50&fit=crop&w=960&h=500', fecha: 21 / 7 / 2010, categoria: 'terror' },
      { titulo: 'Batman es mi amigo', texto: 'Me encontré a batman en el bar', autor: 'Joker', imagen: 'https://i1.wp.com/blog.arielesteban.net/wp-content/uploads/2016/07/batman-blog.jpg?zoom=2&resize=600%2C335', fecha: 21 / 2 / 2019, categoria: 'comedia' },
      ...
      { titulo: 'Superman sin capa me hizo la colada', texto: 'Me lo encontré en la lavanderia a Superman sin capa', autor: 'Aitor tilla', imagen: 'https://www.karengranja.com/wp-content/uploads/2020/09/DSC_4678-700x700.jpg', fecha: 21 / 5 / 2019, categoria: 'comedia' },
